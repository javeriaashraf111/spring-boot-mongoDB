package com.programming.techie.sprintbootmongodbtutorial.config;

import com.github.cloudyrock.mongock.ChangeLog;
import com.github.cloudyrock.mongock.ChangeSet;
import com.programming.techie.sprintbootmongodbtutorial.model.Expense;
import com.programming.techie.sprintbootmongodbtutorial.model.ExpenseCategory;
...
import static com.programming.techie.sprintbootmongodbtutorial.model.ExpenseCategory.*;

@ChangeLog
public class DatabaseChangeLog {
    @ChangeSet(order = "001", id = "seedDatabase", author="Javeria")
    ...
    private Expense createNewExpense(String expenseName, ExpenseCategory expenseCategory, BigDecimal amount){
        ...
        expense.getExpenseCategory(expenseCategory);
        return expense;
    }
}
